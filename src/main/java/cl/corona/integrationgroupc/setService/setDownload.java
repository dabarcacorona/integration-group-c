package cl.corona.integrationgroupc.setService;
...
public class setDownload {
    ...
    @Value("${sftpos.org_TRX}")
    private String o_sftpdtn_TRX;
    ...
    public void DownloadFile() throws IOException {
        ...
        try {
            ...
            Vector<ChannelSftp.LsEntry> entries = sftp.ls(o_sftpdtn_TRX);
            ...
            for (ChannelSftp.LsEntry en : entries) {
                ...
                if (sSubCadena.equals("INVTRHEE")) {
                    LOG.info("Downloading Ventas " + (o_sftpdtn_TRX + en.getFilename()) + " ---> " + pathdest + en.getFilename());
                    sftp.get(o_sftpdtn_TRX + en.getFilename(), pathdest + en.getFilename());
                    sftp.rm(o_sftpdtn_TRX + en.getFilename());
